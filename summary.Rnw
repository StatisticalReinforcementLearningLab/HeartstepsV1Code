...
<<emasummary1, echo=FALSE, dev="tikz", fig.width=9, fig.height=6.5, fig.align="center">>=
par(mfrow = c(2, 4), mar = c(0.5, 4, 0.5, .5), mgp = c(0.5, 0.1, 0),
    oma = c(1, 2, 0, 0), tcl = 0.25, las = 1)
invisible(sapply(users$user[1:8], ema.scale.plot))
@

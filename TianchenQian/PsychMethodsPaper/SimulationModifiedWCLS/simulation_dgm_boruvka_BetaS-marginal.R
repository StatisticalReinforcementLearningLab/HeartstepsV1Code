...
# saveRDS(result, file = "simulation_result_dgm_boruvka_BetaS_n=100,T=30_marginal_nsim1000_glmptilde.RDS")
saveRDS(result, file = "simulation_result_dgm_boruvka_BetaS_n=100,T=30_marginal_nsim10000_constptilde.RDS")


colMeans(result)
# -0.1930679                  NA          -0.1930679          -0.1930679          -0.1928869 
apply(result, 2, sd)
# 0.04078864                  NA           0.04078864          0.04078864          0.04021638 
...
print(xtable(estimate(model4.sens2, normal = FALSE), floating = TRUE, digits = 3,
             caption = "Fitted coefficients and univariate Hotelling's T tests for Model~\\labelcref{eqn:actsed-marginal-model} after removing participant 35 and requiring 37 days on-study",
...
print(xtable(estimate(model4.sens3, normal = FALSE), floating = TRUE, digits = 3,
             caption = "Fitted coefficients and univariate Hotelling's T tests for Model~\\labelcref{eqn:actsed-marginal-model} after removing participant 35 and requiring 38 days on-study",
...
print(xtable(estimate(model4.sens4, normal = FALSE), floating = TRUE, digits = 3,
             caption = "Fitted coefficients and univariate Hotelling's T tests for Model~\\labelcref{eqn:actsed-marginal-model} after removing participant 35 and requiring 41 days on-study",
...
print(xtable(estimate(model4.sens5, normal = FALSE), floating = TRUE, digits = 3,
             caption = "Fitted coefficients and univariate Hotelling's T tests for Model~\\labelcref{eqn:actsed-marginal-model} after removing participant 35 and requiring 42 days on-study",

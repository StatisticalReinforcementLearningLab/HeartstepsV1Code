...
\begin{itemize}
  ...
  \item $A_{1, t}$ is an indicator of whether or not a sedentary suggestion was provided at occasion $t$, and 
  \item $A_{2, t}$ is an indicator of whether or not an active suggestion was provided at occasion $t$.
\end{itemize}
